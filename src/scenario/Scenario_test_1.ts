...
/**
 * Тестовый сценарий - только Kashin и Hunter (без лодки игрока)
 */
export class Scenario_test_1 extends Scenario {
  ...
  public override init(): void {
    ...
    console.log('Scenario_test_1: init начат');
...
`;
    ...
    // Бой будет в открытом море - побережье не генерируем
  ...
  public override showMissinGoal(): void {
    ...
    this.showMissionGoal(
      ...
      "\n\n" +
      "Тестовый сценарий: наблюдение за боем между Kashin и Hunter."
      + "\n"
      + "\nZ - увеличить масштаб"
      + "\nX - уменьшить масштаб"
